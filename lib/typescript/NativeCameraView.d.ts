...
export type NativeCameraViewProps = Omit<CameraProps, 'device' | 'onInitialized' | 'onError' | 'onShutter' | 'onOutputOrientationChanged' | 'onPreviewOrientationChanged' | 'frameProcessor' | 'codeScanner' | 'fps' | 'videoBitRate' | 'onBytesWrittenVideo'> & {
    cameraId: string;
